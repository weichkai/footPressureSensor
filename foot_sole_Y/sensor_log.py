...
class FootSoleGUI(QMainWindow):
    def __init__(self):
        ...
        self.output_file = "sensor_values.txt"
    ...
    def write_sensor_values_to_file(self, sensor_values):
        with open(self.output_file, 'a') as f:
            f.write(' '.join(map(str, sensor_values)) + '\n')
            ...
            while len(self.buffer) >= 216:
                ...
                if frame_head == 0x5Aa5 and frame_type == 0x01 and frame_length == 0x00D6 and package_type == 0x01:
                    ...
                    if calculated_checksum == checksum:
                        ...
                        self.write_sensor_values_to_file(sensor_values)  # Write to file
                    else:
